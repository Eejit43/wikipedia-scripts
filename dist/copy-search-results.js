...
mw.loader.using(['mediawiki.util'], () => {
    ...
    link.addEventListener('click', (event) => {
        ...
        navigator.clipboard.writeText(titles).then(() => mw.notify('Successfully copied search results to clipboard!', { type: 'success' }), () => mw.notify('An error occurred when copying search results to clipboard!', { type: 'error' }));
    });
});
