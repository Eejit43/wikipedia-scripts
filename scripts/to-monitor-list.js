...
const toCheck = {
    categories: [
        ...
        { id: 'incorrect-protection-templates', category: 'Wikipedia pages with incorrect protection templates', notNamespace: 'Article' }
    ],
    searches: [
        ...
        { id: 'draft-displaytitles', search: 'insource:/\\{\\{DISPLAYTITLE:Draft:/i' },
        { id: 'draft-defaultsorts', search: 'insource:/\\{\\{DEFAULTSORT:Draft:/i' },
        { id: 'mainspace-category-links', search: "insource:/((\\]{2}|\\}{2})[^ -�,]|[^ -�,]{2,})\\[\\[:[Cc]ategory:[A-Za-z0-9_\\-–' ]*\\|? ?\\]\\]/" },
        { id: 'external-link-header', search: 'insource:/= ?External link ?=/i' },
        { id: 'reference-header', search: 'insource:/= ?Reference ?=/i' },
        { id: 'pagename-article-namespace', search: 'insource:/\\{\\{PAGENAME\\}\\}/ -insource:"{{PAGENAME}} by default" -insource:"defaults to {{PAGENAME}}" -insource:"Overrides {{PAGENAME}}"' },
        { id: 'capitalized-section-titles', search: 'insource:/= ?(Personal Life|Early Life|See Also|External Links) ?=/' },
        { id: 'bold-text', search: 'insource:/\'{3}Bold text\'{3}/ -indicates -denotes -"Class pole winner"' }, //
        { id: 'italic-text', search: "insource:/'{2}Italic text'{2}/ -indicates -denotes" },
        ...
        { id: 'big-text', search: 'insource:/\\<big\\>Big text\\<\\/big\\>/' },
        { id: 'small-text', search: 'insource:/\\<small\\>Small text\\<\\/small\\>/ -denotes' },
        { id: 'superscript-text', search: 'insource:/\\<sup\\>Superscript text\\<\\/sup\\>/' },
        { id: 'subscript-text', search: 'insource:/\\<sub\\>Subscript text\\<\\/sub\\>/' }
    ],
    whatLinksHere: [
